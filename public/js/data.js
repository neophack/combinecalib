            ...
            load_points: function(){
                ...
                loader.load( this.file_info.get_pcd_path(), 
                    ...
                    function ( pcd ) {
                        ...
                        for (var i=0; i< pcd.position.length/3; i++){

                            if ((pcd.position[i*3]!=NaN)&&(pcd.position[i*3+1]!=NaN)&&(pcd.position[i*3+2])){
                                position.push(pcd.position[i*3]);
                ...
                xhr.onreadystatechange = function () {
                    ...
                    if (this.status == 200) {
                        ...
                        if (this.responseText.length == 0){
                            ...
                            var boxes_t=[],polys_t=[];
                            for(var k in ret){
                                if(ret[k].hasOwnProperty("psr")){
                                    boxes_t.push(ret[k]);
                                }else if(ret[k].hasOwnProperty("poly")){
                                    polys_t.push(ret[k]);     
                                }
                            ...
                            _self.boxes = create_bboxs(boxes_t);  //create in future world      
                            _self.polygons = polys_t;                  
                        }
