...
import {init_image_op, render_2d_image, update_image_box_projection, clear_canvas, clear_main_canvas, choose_best_camera_for_point, image_manager,empty_polys} from "./image.js"
...
function init_gui(){
    ...
    params['remove polygons'] = function () {
        empty_polys();
    };
    fileFolder.add( params, 'remove polygons');
